...
import { NavLink } from 'react-router-dom'  // useNavigate added
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (
                    ...
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow-md border border-gray-200 py-2.5 z-40 rounded-md w-[150px] text-sm'>
            ...
            <div className='flex items-center gap-6 sm:hidden'>
                ...
                <button onClick={() => open?setOpen(close):setOpen(true)} aria-label="Menu" >
