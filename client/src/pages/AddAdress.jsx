...
const AddAddress = () => {
  ...
  const [loadingPage, setLoadingPage] = useState(false); // fullscreen loader
  const [submitting, setSubmitting] = useState(false); // form button loader
    ...
    <div className="mt-30 pb-16 px-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <p className="text-2xl md:text-3xl text-gray-500">
          Manage Shipping{" "}
          <span className="font-bold text-primary">Addresses</span>
        </p>
        <button
          onClick={() => {
            resetForm();
        ...
        <div className="mt-12">
          ...
          <form onSubmit={onSubmitHandler} className="space-y-3 text-sm max-w-xl">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-primary text-white py-2 rounded-md hover:bg-primary-dull transition flex justify-center items-center gap-2"
            >
              {submitting && (
