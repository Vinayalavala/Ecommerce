    ...
    <div className='flex items-center justify-center '>
        <div class="flex flex-col items-center justify-center text-sm h-[400px]">
            ...
            <div class="flex items-center gap-4 mt-6">
                <button type="button" class="bg-primary hover:bg-primary-dull px-7 py-2.5 text-white rounded active:scale-95 transition-all">
                    Go back home
                </button>
                <button onClick={()=>{navigate('/')}} type="button" class="group flex items-center gap-2 px-7 py-2.5 active:scale-95 transition">
                    Contact support
